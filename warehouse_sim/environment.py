...
This module provides a custom Gymnasium environment for the warehouse simulation,
enabling reinforcement learning applications for warehouse optimization.
"""
