...
Examples:
  ...
  python warehouse_video.py simulate --steps 50 --framerate 15
    ...
    # Simulate command
    sim_parser = subparsers.add_parser('simulate', help='Run simulation and create video')
    sim_parser.add_argument('--steps', type=int, default=100, help='Number of simulation steps (default: 100)')
    sim_parser.add_argument('--output', default='warehouse_simulation.mp4', help='Output video file')
    sim_parser.add_argument('--framerate', type=int, default=10, help='Video framerate (default: 10)')
    sim_parser.add_argument('--frames-dir', default='simulation_frames', help='Temporary frames directory')
    sim_parser.add_argument('--keep-frames', action='store_true', help='Keep frame files after video creation')
    sim_parser.add_argument('--save-every', type=int, default=1, help='Save frame every N steps (default: 1)')
    
    # Convert command
    conv_parser = subparsers.add_parser('convert', help='Convert existing frames to video')
    conv_parser.add_argument('frames_dir', help='Directory containing frame images')
    conv_parser.add_argument('--output', default='converted_video.mp4', help='Output video file')
    conv_parser.add_argument('--framerate', type=int, default=10, help='Video framerate (default: 10)')
    conv_parser.add_argument('--pattern', default='frame_%04d.png', help='Frame filename pattern')
